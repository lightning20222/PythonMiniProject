...
def nxtpg():
    ...
    if not count > len(pages) - 2:
        ...
        messagebox.showinfo("Quiz Completed",
                            f"Quiz Completed! Final score: {correct}/{total}")
...
btm_fm = Frame(root)
nxtbtn = Button(btm_fm, text="NEXT \u2192", width=20, command=nxtpg)
nxtbtn.pack(side=tk.RIGHT)
prevbtn = Button(btm_fm, text="\u2190 PREVIOUS", width=20, command=prevpg)
prevbtn.pack(side=tk.LEFT)
...
butt1 = ttk.Button(pg2, text="HELLO", style="success.TButton", width=29).pack(pady=2)
...
player.play()
butt2 = ttk.Button(pg3, text="HELLO", style="warning.TButton", width=29, command=crt_ans).pack(pady=10)
butt3 = ttk.Button(pg3, text="CAP", style="warning.TButton", width=29, command=wng_ans).pack(pady=5)
...
style = ttk.Style()
style.configure('success.TButton', font=('Helvetica', 18))
butt4 = ttk.Button(pg4, text="PLEASE", style="success.TButton", width=29).pack(pady=2)
...
player.play()
butt5 = ttk.Button(pg5, text="HELLO", style="warning.TButton", width=29, command=wng_ans1).pack(pady=10)
butt6 = ttk.Button(pg5, text="PLEASE", style="warning.TButton", width=29, command=crt_ans1).pack(pady=5)
...
style = ttk.Style()
style.configure('success.TButton', font=('Helvetica', 18))
butt7 = ttk.Button(pg7, text="I / ME", style="success.TButton", width=29).pack(pady=2)
...
def click_bind(e):
    global lol2, feedback_label4
    lol2.config(text=f"You Selected: {combo.get()}", fg="orange")
    if combo.get() == "ME":
        feedback_label4.config(text="Correct!", foreground="green")
        crt_ans3()  # Update score for correct answer
    else:
        feedback_label4.config(text="Wrong!", foreground="red")
        wng_ans3()  # Update score for wrong answer
...
combo = ttk.Combobox(pg8, values=val, width=35)
combo.pack(pady=19)
combo.current(0)
...
style = ttk.Style()
style.configure('success.TButton', font=('Helvetica', 18))
butt8 = ttk.Button(pg9, text="FINE", style="success.TButton", width=29).pack(pady=2)
...
player.play()
butt9 = ttk.Button(pg10, text="FINE", style="warning.TButton", width=29, command=crt_ans2).pack(pady=10)

butt10 = ttk.Button(pg10, text="WELCOME", style="warning.TButton", width=29, command=wng_ans2).pack(pady=5)
...
#     global feedback_label_drag
#     if feedback_label_drag:
#         dropped_label = event.widget
#         if dropped_label.cget("text") == "FINE":
#             feedback_label_drag.config(text="Correct!", foreground="green")
#             crt_ans4()  # Update score for correct answer
#         else:
#             feedback_label_drag.config(text="Wrong!", foreground="red")
#             wng_ans4()  # Update score for wrong answer
...
feedback_label_drag = None
# Function to handle drop event and check answer for question 4
def check_drop(event):
...
# Add the check_drop function to handle drop event
label.bind("<Button-1>", drag_start)
label.bind("<B1-Motion>", drag_motion)
label.bind("<ButtonRelease-1>", check_drop)

# # Binding events to enable dragging
# label.bind("<Button-1>", drag_start)
# label.bind("<B1-Motion>", drag_motion)
...
style = ttk.Style()
style.configure('success.TButton', font=('Helvetica', 18))
butt11 = ttk.Button(pg12, text="HELP", style="success.TButton", width=29).pack(pady=2)
...
butt10 = ttk.Button(pg6, text="I AM FINE", style="warning.TButton", width=29, command=wng_ans3).pack(pady=10)

butt11 = ttk.Button(pg6, text="HELP", style="warning.TButton", width=29, command=crt_ans3).pack(pady=5)
